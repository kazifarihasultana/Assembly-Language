...
str3 db 13,10,"The subtraction is: $"   ; String for result message
...
main proc           ; Main procedure
    ...
    sub bl, bh      ; Subtract the second number (BH) from the first number (BL)
    add bl, 48      ; Add 48 to convert the result back to ASCII
